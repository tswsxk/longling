...
from longling.ML.MxnetHelper.mx_gluon import TrainBatchInformer, MovingLosses
from longling.ML.MxnetHelper.mx_gluon import Evaluator, ClassEvaluator
...
from longling.ML.MxnetHelper.mx_gluon import PVWeight, TextCNN
    ...
    def epoch_loop(batch_loop):
        ...
        def decorator(
            ...
            for epoch in range(begin_epoch, epoch_num):
                ...
                print(evaluator.__call__(epoch, test_eval_res, loss_values, train_time,
