...
from longling.infrastructure.config import STAGE_CANDIDATES
from longling.infrastructure.install_proj import project_types
from longling.infrastructure.utils import legal_input, binary_legal_input, default_legal_input
